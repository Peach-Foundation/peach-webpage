...
const Header = () => {
    ...
    const containerStyle = {
        ...
        width: isScroll ? '3rem' : '5rem', // Modify width values as per your requirement
...
{/*                                   
                    ...
                    <a href="https://peach-layer-2.gitbook.io/documentation" target="_blank" rel="noopener noreferrer" >  
...
{/*                       
                  ...
                  <a href="https://peach-layer-2.gitbook.io/documentation/roadmap" target="_blank" rel="noopener noreferrer" >  <div
                            className={` flex items-center ${isScroll ?'text-lg':'text-xl'} font-semibold cursor-pointer`}
